...
from app.ledger import transaction_totals
...
async def create_transaction(
    ...
    2. Ask the database to total the debits and credits it now holds.
    3. Commit only if they match; otherwise roll the whole thing back and 422.
    ...
    Because the check runs before COMMIT, a rejected posting leaves nothing
