...
**Phase 6: Refunds & reconciliation** — money going back, and a job that checks. Done.
**Phase 7: Hardening, observability & deploy** — safe to expose, and legible from
outside. You are here. **This is the last phase.**

---

A payments backend where each phase closes one specific failure the previous phase
left standing — and every fix is a **runnable demonstration**, not a paragraph. The
broken implementations are still in the tree, behind flags, with tests asserting
...
ever fails. [Full section ↓](#phase-4-concurrency)
...
own records. [Full section ↓](#phase-5a-durability)
...
## Phase 7 smoke acceptance criteria
