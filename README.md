...
**Phase 5b: Reliability** — a transactional outbox and idempotent webhooks. You are
here.
...
# 7. Smoke checks (another terminal)
.\scripts\smoke.ps1
...
CI also round-trips the newest migration — `alembic downgrade 0005 && alembic
